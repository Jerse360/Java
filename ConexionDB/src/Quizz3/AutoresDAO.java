...
public class AutoresDAO {
    ...
    public void updateGUI(String nombreCompleto, String fecha_nacimiento, String nacionalidad, int id) {
        Connection con = conexion2.getConnection();
        String query = "UPDATE autores SET nombreCompleto = ?, fecha_nacimiento = ?, nacionalidad = ? WHERE id = ?";
